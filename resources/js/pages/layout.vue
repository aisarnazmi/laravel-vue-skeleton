	...
	<div>
		...
		<div class="lg:hidden">
			...
			<!--
				...
				To: "-translate-x-full"
			-->
			<div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-cyan-400">
		...
		<div class="flex-1 overflow-auto focus:outline-none" tabindex="0">
			...
			<div class="flex-1 px-4 flex justify-between sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
				...
				<div class="ml-3 relative">
					<div>
					<button @click="openSetting = !openSetting" class="max-w-xs bg-white rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 lg:p-2 lg:rounded-md lg:hover:bg-gray-50" id="user-menu" aria-haspopup="true">
						<img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixqx=OaGgfMBpGD&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
					...
					-->
					<div v-if="openSetting" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
